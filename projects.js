let borderColor = ["arrow", "h2", "p", "h1", "icon1", "icon2", "icon3", "icon4", "icon5", "icon6", "block-button1", "block-button2"]
let color = ["h1", "h2", "p", "nav-button1", "nav-button2", "nav-button3", "nav-button4", "change", "drop-button1", "drop-button2"]
let light = function(){
